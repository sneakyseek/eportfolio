        ...
        <div className="modal">
            <div className="modal__half modal__about">
                ...
                <p className="modal__para">
                    ...
                    <br/>
                    I currently work on honing my front end skills, learning from a group of <b className="secondary__color">talented</b> and <b className="secondary__color">experienced </b>
                     freelance frontend engineers, as I study <br/> <b className="secondary__color">backend software development</b> at Virginia Tech
                </p>
